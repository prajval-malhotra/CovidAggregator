...
export default function ResourceList() {
  ...
  const getItems = () => {
    console.log('IN HERE')
    axios.get('https://resources-api-unique.herokuapp.com/api/resources')
      .then(response => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.heading}>Resources near you:</Text>
        ...
        {/* {
          ...
          {
            item.map(t => (
              <ResourceItem item={ t } pressHandler={presshandler} />
            ))
          }
          {/* {console.log(item)} */}
        </ScrollView>
